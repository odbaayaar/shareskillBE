...
export type ResolversTypes = {
  ...
  Error: ResolverTypeWrapper<Scalars['Error']['output']>;
...
export interface ErrorScalarConfig extends GraphQLScalarTypeConfig<ResolversTypes['Error'], any> {
  name: 'Error';
}
